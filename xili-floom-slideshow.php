...
/** 
 * version date 120722 - MS
 */
define('XILIFLOOM_VER','1.1');
			...
			if ( array() != $images ) {
				...
				foreach ( $images as $attach_ID => $image)	 {
					 ...
					 An array containing:
						...
						[2] => height
					 */					 
					 $image_data = wp_get_attachment_image_src ( $attach_ID, $floom_atts['image_size'] ) ; // 1.1
