...
if (!is_admin()) {
	...
	$xili_singular_images = array(); /* used in thumbnailbar of singular */
	/**
	...
	function xilifloom_insert_script() { 
		global $xili_settings, $xilifloom_name_selector, $post, $xili_singular_images;
		...
		if (is_singular()) $xili_singular_images = $images;
				?>
...
add_shortcode('xilifloombar', 'insert_a_floombar');
