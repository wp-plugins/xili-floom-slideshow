...
class xili_floom_activate {
	...
	function  on_normal_1_content($data) { 
		...
		<p><cite><a href='http://wordpress.org/plugins/xili-floom-slideshow/' target='_blank'>xili-floom-slideshow</a></cite>&nbsp;&nbsp;<?php _e("plugin integrates the modules of Floom slideshow in your current theme and detect the specific configurations for Floom in your theme.","xilifloomslideshow"); ?></p>
